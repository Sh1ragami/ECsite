    ...
    <div class="app">
      ...
      <div class="main">
        <div class="sidebar">
          ...
          <button type="submit" value="send" class="example2"><h4 class="h4">売上管理</h4></button></form>
        ...
        <div class="content">
          <div class="flex-content">
            ...
            <input type="submit" value="編集" class="box">
            <input type="submit" value="削除" class="box2">
          </div>
          <fieldset class="waku">
            <?php
            //DB出す処理
